...
from .views import TaskListView, ProfileUser, AboutView, BaseAppInfoView, UserListView, UserProfileDetailView, EmailLogView
...
urlpatterns = [
    ...
    # path('sendmail/', views.celeryemailtask, name="sendmail"),
